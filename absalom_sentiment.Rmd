...
#Tidy the begin_word vector by unnesting it into individual words. In the tidytext package, unnesting removes white spaces, punctuation, and special characters. The only special character that might remain is the curly quote [‘’]. These have a tendency to mess up the matching and have been replaced with straight quotes [']. Once all the words are clean, they are collapsed back into sentences.
